...
public abstract class CharacterRelated : CommonRelated {
    ...
    public string SuperBoonBane(Stats Base_stats, Stats Growth_rates, Stats lvl40) {
        return (Util.SuperStats(Base_stats, Growth_rates, lvl40, true, "Superboon").Equals("") ? "" : Util.SuperStats(Base_stats, Growth_rates, lvl40, true, "Superboon") + Environment.NewLine) + (Util.SuperStats(Base_stats, Growth_rates, lvl40, false, "Superbane").Equals("") ? "" : Util.SuperStats(Base_stats, Growth_rates, lvl40, false, "Superbane") + Environment.NewLine);
    }
...
public class SingleSkill : CommonRelated {
    ...
    public override void InsertIn(long a, byte[] data) {
        ...
        Passive_next = new StringXor(ExtractUtils.getULong(a + 232, data) + (uint) offset, data, Common);
