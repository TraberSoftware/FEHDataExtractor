...
namespace FEHDataExtractorLib {
    ...
    public class ArenaAssaultItem : SingleCountDependant {
        private byte item;
        public readonly StringsUpdatable ArenaAssaultItems = new StringsUpdatable(new string[] {
            "Elixir",
            "Fortifying Horn",
            "Special Blade",
            "Infantry Boots",
        ...
        public override string ToString() {
            String text  = Count + " " + ArenaAssaultItems.Get(Item);
                   text += Count > 1 ? "s" : "";
            return text;
        }
    }
    ...
    public class Reward_Payload : ExtractionBase {
        ...
        public static readonly byte[] AES128Key = {
    ...
    public class Reward_Definition : ExtractionBase {
        ...
        public static readonly byte[] ChecksumPrivateKey = {
            0x4a, 0xb5, 0x6f, 0xfc, 0xfc, 0xad, 0xf8, 0x28,
            0x90, 0x92, 0x3c, 0x64, 0x4a, 0x2f, 0xa2, 0x7b,
            0x22, 0xdc, 0x04, 0xf7, 0xbf, 0xef, 0xa4, 0xd1,
            0xa1, 0x0e, 0xfc, 0xd2, 0x7a, 0xc3, 0x5e, 0x2a,
            0xba, 0x87, 0xcd, 0x0f, 0xb8, 0xcc, 0xcb, 0xf6,
            0xb8, 0xe1, 0x4f, 0xdb, 0xde, 0xc9, 0xcd, 0xda,
            0xb5, 0xf0, 0x81, 0x36, 0x27, 0xbb, 0x23, 0xb3,
            0x77, 0x45, 0x71, 0x48, 0x3c, 0x83, 0x6b, 0xe2
        };
