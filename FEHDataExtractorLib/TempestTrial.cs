...
namespace FEHDataExtractorLib {
    public class TempestTrial : CommonRelated {
                StringXor        id_tag;
    ...
    public class Single_entry : CommonRelated {
        StringXor    id;
        Single_map[] possible_maps;             // possible_maps_collections
    ...
    public class Single_map : CommonRelated {
        ...
        public Single_map(long a, byte[] data) : this() { InsertIn(a, data); }
    ...
    */
    public class TT_point_rewards : ExtractionBase {
        ...
        public TT_point_rewards(long a, byte[] data) : this() { InsertIn(a, data); }
    ...
    public class TT_rank_rewards : ExtractionBase {
        ...
        public TT_rank_rewards(long a, byte[] data) : this() { InsertIn(a, data); }
